...
public final class StringUtil {
     ...
     *
     * @param inString   被操作的字符串
     * @param oldPattern 将被替换的老字符串
     * @param newPattern 被替换成的新字符串
     * @return 替换完成后的字符串
     */
     ...
     *
     * @param inString      被操作的字符串
     * @param charsToDelete 一个由将被删除的字符组成的字符串
     ...
     *
     * @param array1 添加目标字符串数组
     * @param array2 将被加入的字符串元素
     * @return 添加完成的字符串数组
     */
     ...
     *
     * @param perfix              每个元素的前缀
     * @param suffix              每个元素的后缀
     * @param separator           元素之间的分隔符
     * @param deleteLastSeparator 是否删除最后一个分隔符
     * @param array               字符串数组
     * @return 连接完成的字符串
     */
    ...
    /**
     * 把字符串集合中的元素用分隔符分隔后，组成一个大字符串
     *
     * @param coll    字符串集合
     * @param spliter 分隔符
     * @return 组成的大字符串
     */
    public static String join(Collection<String> coll, String spliter) {
        return coll.stream().collect(Collectors.joining(spliter));
    }

    /**
     * 把字符串数组中的元素用分隔符分隔后，组成一个大字符串
     *
     * @param array    字符串数组
     * @param spliter 分隔符
     * @return 组成的大字符串
     */
    public static String join(String[] array, String spliter) {
        return Arrays.stream(array).collect(Collectors.joining(spliter));
    }
}
